...
public class Place implements Serializable {//地点详情
    ...
    public Place(String city, String name, String desc, String tel, String web, String tourtime, String traffic, String price, String open_time, String location, String comment_num, String longitude, String latitude) {
        this.city = city;
        this.name = name;
        this.desc = desc;
        this.tel = tel;
